# StatOwrel 1.0.1-rc1 — notes de version
...
> ⚠️ **Cette rc change de SDK Firebase.** L'app parle désormais aux SDK natifs (React Native
> Firebase) et plus au SDK web : auth, Firestore, callables et push passent tous par un code
> nouveau. La **régression complète** ci-dessous n'est pas optionnelle pour cette rc — elle est le
> test de la migration.

### Delta de la 1.0.1-rc1 — à passer en priorité
...
- [ ] Push de 7h reçue sur un build de cette rc (jeton enregistré via le nouveau SDK)
...
- [ ] Captures 1 à 3 de `docs/store-listing.md` §3.1 aux deux formats iOS et au format Play —
      **à refaire sur cette rc** : la question du jour est désormais un modal pleine hauteur
...
- [ ] Delta de la 1.0.1-rc1 ci-dessus passé en entier, **migration React Native Firebase comprise**
