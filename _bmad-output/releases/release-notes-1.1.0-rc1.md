# StatOwrel 1.1.0-rc1 — notes de version

| Champ | Valeur |
|---|---|
| Version | **1.1.0-rc1** (`version` applicative : `1.1.0` dans `apps/app/package.json` et `apps/app/app.config.ts` — Expo et l'App Store n'acceptent pas de suffixe pré-release) |
...
| Date | 2026-09-02 |
| Nature | **pre-release** — première rc de la 1.1.0 |
