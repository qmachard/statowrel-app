...
Still missing: the monochrome Android status-bar icon (Expo falls back to the app icon, which Android renders as a white blob), the notification preferences of `docs/prd.md` §5.3, and any use of a notification other than the daily one.
