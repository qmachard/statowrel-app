...
4. **iOS links dynamically.** The Firebase Apple SDK resolves through Swift Package Manager on React Native 0.75+, which requires dynamic frameworks — hence `expo-build-properties` with `useFrameworks: 'dynamic'` in the plugin list.
