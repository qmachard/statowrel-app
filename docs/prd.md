...
**2. Invitations reçues.** Tant qu'une invitation attend une réponse, elle est reprise en haut de l'écran Stats — la carte de la liste d'amis (§5.3), réduite aux seules invitations reçues, avec « Accepter » sous la mention et le refus dans le menu de la ligne. Sans invitation en attente, rien ne s'affiche.
