          ...
          <View style={styles.form}>
            ...
            {canBeReferred ? (
              <View style={styles.referral}>
                ...
                {/* The reader's own side of it, and only theirs: what the
                    sponsor earns is none of their business and would make the
                    field read as somebody else's errand. */}
                <Text style={styles.hint}>
                  Tu gagnes {amountLabel(REFERRAL_WELCOME_STATFLOUZZ_BONUS)} dès ta première réponse.
                </Text>
              </View>
            ) : null}
